# -*- coding: utf-8 -*-
"""
Created on Tue Jan 26 17:23:51 2016
Poincare section (maximum driving force), using Euler-Cromer method.
@author: nightwing
"""
...
def PHYSICAL_PENDULUM(q,fd,freq,theta):
    ...
    while t <= t_end:
        if abs(round((t*freq-pi/2)/(2*pi)) - (t*freq-pi/2)/(2*pi)) < 0.001: 
