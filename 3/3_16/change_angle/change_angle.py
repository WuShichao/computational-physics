# -*- coding: utf-8 -*-
"""
Created on Wed Jan 27 15:31:29 2016
Investigate how a strange attractor is altered by small changes in
one of the pendulum parameters(change initial angle), using Euler-Cromer method. 
@author: nightwing
"""
...
for index in tqdm(range(0, number)):
    ...
    for F in [0.5, 1.2]:
        situations.append(PHYSICAL_PENDULUM(0.5, F, 2/3.0, 0.2*k)) 
    #----------------graph--------------
